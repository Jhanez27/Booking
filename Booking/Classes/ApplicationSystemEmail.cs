...
namespace Booking.Classes
{
    public class ApplicationSystemEmail
    {
        ...
        public void sendEmailWithAttachment(string accEmail, string filePath)
        {
            ...
            try
            {
                ...
                using (var smtp = new SmtpClient())
                {
                    ...
                    using (var message = new MailMessage())
                    {
                        message.From = new MailAddress("ticketeasebookingnotification@gmail.com");
                        message.To.Add(accEmail);
                        message.Subject = "Iterinary Receipt";
                        message.Body = "This is your iterinary receipt. Please have it printed before boarding. Thank you for using our service.";
